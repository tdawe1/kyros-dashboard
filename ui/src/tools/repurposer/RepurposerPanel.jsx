...
export default function RepurposerPanel() {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            ...
            />
            {errors.inputText && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.inputText}</p>
            )}
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            ...
            {errors.channels && (
              <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.channels}</p>
            )}
          </div>
        </div>
