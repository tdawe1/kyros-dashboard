...
class TokenBucketRateLimiter:
    ...
    def is_allowed(self, request: Request) -> tuple[bool, dict]:
        ...
        try:
            ...
            reset_time = current_time + ((1 - tokens) * (RATE_LIMIT_WINDOW / RATE_LIMIT_REQUESTS))
            ...
            logger.debug(f"Rate limit check for {client_id}: allowed={is_allowed}, tokens={tokens:.2f}")
